...
Insert into STUDENT (STUDNO,NAME,USERID,GRADE,IDNUM,BIRTHDATE,TEL,HEIGHT,WEIGHT,DEPTNO,PROFNO) values (12345,'김김김',null,null,null,null,null,null,null,101,null);
REM INSERTING into SUBJECT
SET DEFINE OFF;
Insert into SUBJECT (SUBNO,SUBNAME,TERM,TYPE) values (1001,'자바','1',null);
Insert into SUBJECT (SUBNO,SUBNAME,TERM,TYPE) values (1002,'오라클','2',null);
REM INSERTING into SUGANG
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index PK_DEPARTMENT
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_DEPARTMENT" ON "DEPARTMENT" ("DEPTNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_DEPT_NAME
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PK_PROFESSOR" ON "PROFESSOR" ("PROFNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PK_STUDENT" ON "STUDENT" ("STUDNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index UK_IDNUM
--------------------------------------------------------

  CREATE UNIQUE INDEX "UK_IDNUM" ON "STUDENT" ("IDNUM") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index UK_USERID
--------------------------------------------------------

  CREATE UNIQUE INDEX "UK_USERID" ON "STUDENT" ("USERID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_STUD_BIRTHDATE
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_STUD_DNO_GRADE
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index IDX_STUD_DNO_NAME
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE INDEX "PK_SUBJECT" ON "SUBJECT" ("SUBNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_SUGANG
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_SUGANG" ON "SUGANG" ("STUDNO", "SUBNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "DEPARTMENT" MODIFY ("DNAME" CONSTRAINT "NN_DNAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "PROFESSOR" MODIFY ("NAME" CONSTRAINT "NN_PROF_NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "STUDENT" ADD CONSTRAINT "CK_GRADE" CHECK (grade BETWEEN '1' AND 4) ENABLE;
  ALTER TABLE "STUDENT" ADD CONSTRAINT "UK_USERID" UNIQUE ("USERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "STUDENT" MODIFY ("NAME" CONSTRAINT "NN_NAME" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SUBJECT" ADD CONSTRAINT "PK_SUBJECT" PRIMARY KEY ("SUBNO") DEFERRABLE INITIALLY DEFERRED
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SUBJECT" ADD CONSTRAINT "CK_TERM" CHECK (term in ('1', '2')) ENABLE;
  ALTER TABLE "SUBJECT" MODIFY ("SUBNAME" CONSTRAINT "NN_SUBNAME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "DEPARTMENT" ADD CONSTRAINT "FK_COLLEGE" FOREIGN KEY ("COLLEGE")
	  REFERENCES "DEPARTMENT" ("DEPTNO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PROFESSOR
--------------------------------------------------------

  ALTER TABLE "PROFESSOR" ADD CONSTRAINT "FK_PROF_DEPTNO" FOREIGN KEY ("DEPTNO")
	  REFERENCES "DEPARTMENT" ("DEPTNO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table STUDENT
--------------------------------------------------------

  ALTER TABLE "STUDENT" ADD CONSTRAINT "FK_DEPTNO" FOREIGN KEY ("DEPTNO")
	  REFERENCES "DEPARTMENT" ("DEPTNO") ENABLE;
  ALTER TABLE "STUDENT" ADD CONSTRAINT "FK_STUD_PROFNO" FOREIGN KEY ("PROFNO")
	  REFERENCES "PROFESSOR" ("PROFNO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SUGANG
--------------------------------------------------------

  ALTER TABLE "SUGANG" ADD CONSTRAINT "FK_SUGANG_STUDNO" FOREIGN KEY ("STUDNO")
	  REFERENCES "STUDENT" ("STUDNO") ENABLE;
  ALTER TABLE "SUGANG" ADD CONSTRAINT "FK_SUGANG_SUBNO" FOREIGN KEY ("SUBNO")
	  REFERENCES "SUBJECT" ("SUBNO") ENABLE;
